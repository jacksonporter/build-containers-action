...
> We extend our gratitude to the GitHub Actions team for providing this
...
[Actions tab](https://github.com/jacksonporter/build-containers-action/actions)!
:rocket:
...
steps:
  ...
  - name: Test Local Action
    id: test-action
    uses: jacksonporter/build-containers-action@v1 # Commit with the `v1` tag
    with:
      milliseconds: 1000
